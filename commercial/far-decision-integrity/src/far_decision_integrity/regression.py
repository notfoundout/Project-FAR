        ...
        "cases": [
            {
                ...
                "baseline": {
                    "integrity_status": case.baseline.integrity_status,
                    "disposition": case.baseline.disposition,
                },
                "candidate": {
                    "integrity_status": case.candidate.integrity_status,
                    "disposition": case.candidate.disposition,
                },
