...
class RepresentationDiscoverySeparationTests(unittest.TestCase):
    ...
    def test_generic_baseline_has_no_result_yet(self) -> None:
        ...
        self.assertEqual(self.baseline["current_result"], expected)
        self.assertEqual(self.factor_result["dimensions"], expected)
        self.assertFalse(self.factor_result["factorization_contract"]["primitive_reduction_established"])
