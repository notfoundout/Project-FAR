...
class CRE001SemanticRegressionTests(unittest.TestCase):
    ...
    def test_generated_task_ids_and_provenance_are_unambiguous(self):
        ...
        self.assertIn('### STRATEGIC-001: Prove the W0 S_core normalization kernel', ranked)
        self.assertIn('### STRATEGIC-002: Prove base carrier and direct-axis constructors', ranked)
        self.assertIn('### STRATEGIC-003: Prove dynamics, history, and revision constructors', ranked)
        self.assertIn('37 open obligations, zero proved obligations, and W0 is active', ranked)
