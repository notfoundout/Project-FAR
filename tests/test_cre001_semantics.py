...
class CRE001SemanticRegressionTests(unittest.TestCase):
    ...
    def test_generated_task_ids_and_provenance_are_unambiguous(self):
        ...
        self.assertIn('### STRATEGIC-002: Execute reasoning/contrast discrimination and FARA specificity',ranked)
        ...
        self.assertIn('`RCS-CORPUS-001` and bounded GREL-FARA factorization are complete',ranked)
        self.assertIn('Reasoning/contrast discrimination and FARA-specificity are next',ranked)
