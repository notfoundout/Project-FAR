...
class CRE001SemanticRegressionTests(unittest.TestCase):
    ...
    def test_generated_task_ids_and_provenance_are_unambiguous(self):
        ...
        self.assertIn("- Priority: preregistered intake; no test executed", ranked)
        self.assertIn("It is not W7", ranked)
        ...
        self.assertIn("The sealed W1 I1 claimed-isolation review", ranked)
        self.assertIn("Current program: `EXTERNAL-FALSIFICATION-AND-REPLICATION-001`", ranked)
