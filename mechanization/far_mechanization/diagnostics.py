...
class DiagnosticCode(StrEnum):
    ...
    MISSING_REFERENCE = "FAR-GRAPH-001"
    DUPLICATE_REFERENCE = "FAR-GRAPH-002"
    DEPENDENCY_CYCLE = "FAR-GRAPH-003"
    BROKEN_DEPENDENCY = "FAR-GRAPH-004"
    ORPHAN_NODE = "FAR-GRAPH-005"
    INVALID_EDGE = "FAR-GRAPH-006"
    INVALID_NODE = "FAR-GRAPH-007"
    GRAPH_DISCONNECTED = "FAR-GRAPH-008"
    UNREACHABLE_NODE = "FAR-GRAPH-009"
    INVALID_DEPENDENCY_DIRECTION = "FAR-GRAPH-010"
    INVALID_ROOT = "FAR-GRAPH-011"
    DUPLICATE_GRAPH_NODE = "FAR-GRAPH-012"
    DUPLICATE_GRAPH_EDGE = "FAR-GRAPH-013"
    UNKNOWN_DEPENDENCY_TYPE = "FAR-GRAPH-014"
    DEPENDENCY_KIND_MISMATCH = "FAR-GRAPH-015"
