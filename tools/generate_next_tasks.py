...
def main():
    ...
    if not tasks:
        tasks=[{'id':'TASK-001','gap':'GAP-001','priority':'low','title':'Review generated status report','why':'Keep advisory planning current.','affected':[markdown_link(STATUS, OUT)],'outcome':'Human confirms planner output remains aligned with evidence.','risk':'low','branch':'maintenance/review-generated-status','pr':'Review generated Project FAR status'}]
