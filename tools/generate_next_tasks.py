...
def strategic_tasks():
    return [
        {'id':'STRATEGIC-001','gap':None,'priority':'high','title':'Design and preregister CRE-002','why':'Vocabulary Semantics Baseline 1.0 is now frozen prospectively for CRE-002 and later; CRE-001 remains retrospective compiler-authored declared-interpretation evidence.','affected':[markdown_link(ROOT / 'theory/evaluation/comparative-representation', OUT), markdown_link(ROOT / 'docs/ROADMAP.md', OUT), markdown_link(ROOT / 'theory/evaluation/comparative-representation/experiments/CRE-001/semantics/formal-semantics.md', OUT)],'outcome':'Preregistered CRE-002 design using Vocabulary Semantics Baseline 1.0 as prospective authority while preserving all CRE-001 limitations.','risk':'high','branch':'research/preregister-cre-002','pr':'Design and preregister CRE-002'},
        {'id':'STRATEGIC-002','gap':None,'priority':'high','title':'Execute CRE-002 prospectively','why':'Prospective execution is needed to collect evidence not already fixed by deterministic CRE-001 artifacts and to test encodings against the prospective vocabulary baseline.','affected':[markdown_link(ROOT / 'theory/evaluation/comparative-representation', OUT)],'outcome':'Prospective CRE-002 execution records under the frozen preregistered protocol.','risk':'high','branch':'research/execute-cre-002','pr':'Execute CRE-002 prospectively'},
        {'id':'STRATEGIC-003','gap':None,'priority':'medium','title':'Analyze prospective CRE-002 evidence','why':'Prospective records must be analyzed before any new comparative conclusion is considered.','affected':[markdown_link(ROOT / 'docs/reports', OUT), markdown_link(ROOT / 'theory/evaluation/comparative-representation', OUT)],'outcome':'Cautious analysis that states supported and unsupported conclusions.','risk':'medium','branch':'research/analyze-cre-002-evidence','pr':'Analyze prospective CRE-002 evidence'},
        {'id':'STRATEGIC-004','gap':None,'priority':'medium','title':'Plan independent replication','why':'Deterministic CRE-001 repository integration and post-CRE-001 semantic baseline are not independent replication.','affected':[markdown_link(ROOT / 'docs/methodology/adversarial-evaluation.md', OUT), markdown_link(ROOT / 'docs/governance/central-research-program.md', OUT)],'outcome':'Replication plan with isolation, provenance, and limitation language.','risk':'medium','branch':'research/plan-independent-replication','pr':'Plan independent replication'},
        {'id':'STRATEGIC-005','gap':None,'priority':'medium','title':'Monitor frozen vocabulary semantic drift','why':'Semantic regression protects Vocabulary Semantics Baseline 1.0 from drift before CRE-002 and later prospective reuse.','affected':[markdown_link(ROOT / 'theory/evaluation/comparative-representation/experiments/CRE-001/semantics/semantic-regression.md', OUT), markdown_link(ROOT / 'tools/check_cre001_semantics.py', OUT)],'outcome':'Semantic drift monitoring remains active without changing frozen conclusions.','risk':'medium','branch':'maintenance/monitor-cre001-semantic-drift','pr':'Monitor CRE-001 semantic drift'},
    ]
