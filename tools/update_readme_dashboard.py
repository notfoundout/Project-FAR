...
def block():
    ...
    nav=[('Project Status',STATUS),('Research Gap Report',GAPS),('Next Actions',NEXT),('Dashboard Metrics',METRICS),('External Validation','docs/reports/external-validation-report.md'),('Primitive Sufficiency','docs/reports/primitive-sufficiency-report.md'),('Evidence Registry',REG['evidence']),('External Validation Registry',REG['external']),('Primitive Pressure Registry',REG['pressure']),('Adversarial Test Suite',REG['adversarial']),('Releases','docs/releases'),('Maintenance','docs/maintenance'),('Planning','docs/planning/README.md'),('Repository Index',INDEX),('Dependency Report','docs/reports/dependency-report.md'),('Dependency Graph JSON','docs/reports/dependency-graph.json'),('Dependency Graph Mermaid','docs/reports/dependency-graph.mmd'),('Dependency Registry','theory/dependencies/dependency-registry.yaml'),('Dependency Schema','theory/dependencies/dependency-schema.yaml')]
