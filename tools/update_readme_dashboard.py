...
def block():
    ...
    '## Typical Workflow','','1. `make research-check`','2. `make health-fast`','3. Open THM-TARGET-001','4. Choose the highest unsatisfied theorem obligation','5. Freeze exact semantics, assumptions, failure conditions, and nonclaims','6. Prove, refute, or register the obstruction','7. Preserve all failures and unresolved obligations','8. Run health','9. Merge','',END]
    return '\n'.join(lines)+'\n'
def main():
