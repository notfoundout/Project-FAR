...
def block():
    ...
    '## Typical Workflow','','1. `make research-check`','2. `make health-fast`','3. Open the Deduction-First Research Standard','4. Open the Proof Roadmap','5. Choose the highest unsatisfied theorem obligation','6. Freeze its statement, assumptions, failure conditions, and nonclaims','7. Prove, refute, or register the obstruction','8. Preserve all failures and unresolved obligations','9. Run health','10. Merge','',END]
    return '\n'.join(lines)+'\n'
def main():
