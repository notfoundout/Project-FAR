...
def block():
    ...
    nav=[('Project Status',STATUS),('Research Gap Report',GAPS),('Next Actions',NEXT),('Dashboard Metrics',METRICS),('Deduction-First Standard','docs/governance/deduction-first-research-standard.md'),('Proof Roadmap','docs/planning/deduction-first-proof-roadmap.md'),('THM-TARGET-001','docs/research/thm-target-001-v1.0.md'),('Faithful Representation','docs/research/faithful-representation-specification-v1.0.md'),('P8 Role Decision','docs/research/p8-theorem-role-decision-v1.0.md'),('S_core Lemma Ledger','docs/research/s-core-construction-obstruction-ledger-v1.0.md'),('S_core Lemma Registry','theory/evaluation/s-core-construction-obstruction-ledger.json'),('Evidence Registry',REG['evidence']),('External Validation Registry',REG['external']),('Primitive Pressure Registry',REG['pressure']),('Adversarial Test Suite',REG['adversarial']),('Releases','docs/releases'),('Maintenance','docs/maintenance'),('Planning','docs/planning/README.md'),('Repository Index',INDEX)]
    lines += ['','## Repository Navigation','']+[f'- {link(p,label)}' for label,p in nav]
    lines += ['','## Current Roadmap','','- Current phase: S_core W0 normalization lemma execution','- Completed foundation for the active phase: architecture-neutral domain; IRD-001; PB-001; PBTS-001; deduction-first governance; THM-TARGET-001; premise ledger v1.2; FAITHFUL-REP-001; P8-ROLE-001 split decision; SCORE-LEMMA-LEDGER-001 with 37 registered unproved obligations','- In-progress work: prove or refute LEM-SC-001 through LEM-SC-004 and test OBS-SC-001','- Planned work: W1 direct-axis constructors; W2 dynamics and history; W3 global witness obligations; W4 obstruction controls; W5 theorem assembly; extension analysis; lower bounds; minimality; mechanization; independent review','- Parallel supporting work: PBTS-001 independent replication, comparative evaluation, boundary discovery, and application validation','','## Command Center','','### Local Commands','','```bash\nmake research-check\nmake health-fast\nmake health\nmake docs-check\nmake plan\nmake dashboard\n```','','### GitHub Actions','',f'- Repository Health: {workflow("repository-health.yml")}',f'- Regenerate Dashboard: {workflow("regenerate-dashboard.yml")}',f'- Release Readiness: {workflow("release-readiness.yml")}',f'- Repository Maintenance: {workflow("repository-maintenance.yml")}','','## Typical Workflow','','1. `make research-check`','2. `make health-fast`','3. Open SCORE-LEMMA-LEDGER-001','4. Select the earliest open obligation whose dependencies are resolved','5. Freeze assumptions, proof statement, countermodels, failure conditions, and nonclaims','6. Prove, refute, or register the obstruction','7. Preserve failures and unresolved obligations','8. Run health','9. Merge','',END]
    return '\n'.join(lines)+'\n'
def main():
