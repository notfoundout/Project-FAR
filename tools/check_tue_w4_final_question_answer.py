...
def main() -> int:
    ...
    require(result["program_disposition"] == "closed_with_final_internal_answer", "program not closed")
    ...
    require(program["status"] == "complete", "program status not complete")
    require(program["program_disposition"] == "closed_with_final_internal_answer", "program disposition wrong")
