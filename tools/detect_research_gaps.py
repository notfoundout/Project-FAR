...
def main():
    ...
    lines=['# Research Gap Report','', '## Navigation','', *nav_links(OUT), '', 'Generated by `python tools/detect_research_gaps.py`. Findings are advisory and require human review.','', '| Gap ID | Type | Location | Severity | Recommended Action |','|---|---|---|---|---|']
