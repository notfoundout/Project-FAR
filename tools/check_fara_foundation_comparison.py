...
from fara_foundation_authoritative_prose import validate_text as validate_authoritative_prose_text
...
def validate_authoritative_text(text,p):
 return validate_authoritative_prose_text(text,p,authoritative_snapshot)
