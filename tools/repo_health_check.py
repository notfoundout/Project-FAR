...
add('mechanization unittest suite', [sys.executable, '-m', 'unittest', 'discover', '-s', 'tests/mechanization', '-p', 'test_*.py'])
for tool in ['verify_theory.py','check_dependencies.py','check_dependency_registry.py','check_registry.py','check_notation.py','check_circularity.py','generate_theorem_index.py','check_repository_hygiene.py','check_certification_compliance.py','check_math_rendering.py','check_markdown_hygiene.py','check_release_consistency.py','check_internal_links.py']:
