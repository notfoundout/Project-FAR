...
def main()->int:
    ...
    target=load(TARGET); assert target['proof_status']=='partial_lemma_progress_only'; assert next(x for x in target['theorem_family'] if x['id']=='THM-CORE-REP-001')['status']!='proved'
    ...
    print('FAITHFUL-REP-001 validation PASS (finite construction/recovery conjuncts proved; Nontrivial and theorem assembly open)'); return 0
