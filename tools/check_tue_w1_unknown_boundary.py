...
def main() -> None:
    ...
    for key in (
        "pre_mapping_source_distinctions_required",
        "candidate_generation_trace_required_for_creative_case",
        "reason_or_salience_elicitation_required_for_moral_case",
        "selective_ground_defeat_intervention_required",
        "path_sensitive_retest_required",
        "uniform_query_interface_required",
        "missing_evidence_is_unknown_not_pass",
        "retrospective_rationalization_not_equivalent_to_process_ground",
        "all_prompting_logging_elicitation_and_decoder_machinery_charged",
    ):
    ...
    require(counts == {
        "unknowns_resolved_within_rccd": 1,
        "genuine_extension_required": 0,
        "principled_inaccessibility_boundary": 2,
        "mixed_or_unresolved": 0,
    }, "terminal counts inconsistent")
    ...
    require([x["target_pr"] for x in queue["completed_workstreams"]] == [276, 277], "completed sequence incorrect")
    ...
    print("PASS: TUE-W1 unknown-boundary package is complete and internally consistent")
