...
ROOT=Path(__file__).resolve().parents[1]; OUT=ROOT/'docs/reports/project-status-generated.md'; LEDGER=ROOT/'theory/evaluation/s-core-construction-obstruction-ledger.json'; W35=ROOT/'theory/evaluation/w3-5-specificity-and-discovery-gate.json'; SCOPE=ROOT/'theory/evaluation/reasoning-and-contrast-scope-v1.0.json'; CANDIDATES=ROOT/'theory/evaluation/universal-structure-candidate-registry.json'
REPORTS=[('Central Research Program','docs/governance/central-research-program.md'),('Representation–Discovery Separation Standard','docs/governance/representation-discovery-separation-standard-v1.0.md'),('Deduction-First Proof Roadmap','docs/planning/deduction-first-proof-roadmap.md'),('Architecture-Neutral Research Roadmap','docs/planning/architecture-neutral-research-roadmap.md'),('W4 Negative-Control Proof','docs/research/s-core-w4-negative-control-proof-v1.0.md'),('Generic Relational Baseline','docs/research/generic-relational-baseline-v1.0.md'),('Reasoning and Contrast Scope','docs/research/reasoning-and-contrast-scope-v1.0.md'),('Universal-Structure Discovery Target','docs/research/universal-structure-discovery-target-v1.0.md'),('W3.5 Gate','docs/research/w3-5-specificity-and-discovery-gate-v1.0.md')]
...
def main()->int:
    ...
    f"- ADJ status: W3.5 `{w35['status']}`; concrete corpus and all factorization dimensions unresolved.",
    ...
    f"- Registered negative-control obstructions established: {summary['obstruction_established']}",
    f"- Open assembly obligations: {summary['open']}",
    f"- Active status: {ledger['active_wave']}",'','## ADJ Status','',
    ...
    'W0-W4 establish project-authored bounded REP results for frozen `S_core`, including rejection of the applicable registered NC-01 through NC-10 families. They do not establish complete `Faithful_split`, FARA-specificity, a representation theorem, or universal structure. W3.5 is the sole live blocker before W5.','','## Relevant Reports','']
