...
def main() -> int:
    ...
    conclusion = (
        "CRE-002-EXT-001 establishes a prospective bounded result under Vocabulary Semantics Baseline 1.1: "
        ...
        "primitive-only or universal sufficiency, necessity, minimality, independence, superiority, FAR proof, universal reasoning "
        "structure, or independent replication. The original CRE-002 result remains unsupported under Baseline 1.0 and is not retroactively changed."
    )
    lines = [
