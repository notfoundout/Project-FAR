...
def main() -> int:
    ...
    conclusion = "CRE-001 demonstrates only that compiler-authored declared interpretations successfully compiled, lowered, and verified under the registered deterministic reference. Vocabulary Semantics Baseline 1.0 was formalized after deterministic CRE-001 and is prospective for CRE-002 and later only. CRE-001 does not establish formal vocabulary licensing, primitive sufficiency, universal sufficiency, necessity, minimality, independence, superiority, FAR proof, or universal reasoning structure."
    lines = [
    ...
    lines += ["", "## Deterministic CRE-001 Status", "", "Completed: deterministic CRE-001 implementation; vocabulary-native compilation; executable lowering; deterministic verification; replayable lowering traces; mutation testing; adversarial compiler audit; repository integration.", "", "Prospective baseline: Vocabulary Semantics Baseline 1.0 is frozen for CRE-002 and later; it is not independent evidence supporting CRE-001 and cannot retrospectively validate CRE-001.", "", "Not established by CRE-001: formal vocabulary licensing; primitive sufficiency; universal sufficiency; necessity; minimality; independence; superiority; FAR proof; universal reasoning structure.", "", "## Current Evidence Conclusion", "", conclusion, "", "## Relevant Reports", ""]
    for r in REPORTS:
