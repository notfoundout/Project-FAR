...
def main() -> int:
    ...
    lines += ["", "## Deterministic CRE-001 Status", "", "Completed: deterministic CRE-001 implementation; vocabulary-native compilation; executable lowering; deterministic verification; replayable lowering traces; mutation testing; adversarial compiler audit; repository integration.", "", "Not established: universal sufficiency; primitive-only sufficiency; necessity; minimality; independence; superiority; FAR proof; universal reasoning structure; formally licensed vocabulary semantics.", "", "## Current Evidence Conclusion", "", conclusion, "", "## Relevant Reports", ""]
    for r in REPORTS:
