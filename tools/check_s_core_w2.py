...
def main()->int:
    ...
    target=load(TARGET); assert target['lemma_program']['completed_waves'][:3]==['W0','W1','W2']; assert target['proof_status']=='partial_lemma_progress_only' and target['independent_review_status']=='not_started'
    ...
    print('S_core W2 proof: PASS (retained after W3; dynamics/history results remain established)'); return 0
