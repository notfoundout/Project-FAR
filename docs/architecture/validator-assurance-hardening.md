...
- `FAR_GITHUB_ADMIN_TOKEN`: repository-scoped fine-grained administrator token used only to apply and verify canonical branch protection. Rotate or replace it before expiration if future protection reapplication is required.
