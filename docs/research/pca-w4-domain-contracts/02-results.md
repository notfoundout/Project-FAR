...
| Bayesian/causal | observational joint distribution | `REFUTED`: observationally equal; `P(Y=1 given do(X=0))` is `0` vs `1/2` | declared intervention response distribution | `PROVED` finite factorization |
