...
| PCA-W2 Formalization Status | [`governance/pca-w2-formalization-status-v1.0.md`](governance/pca-w2-formalization-status-v1.0.md) | Records 13 formalized claims and FAR-CORE-014's exact reproducible MLL obstruction. |
