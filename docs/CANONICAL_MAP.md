...
| EFR-R2 Input-Specification Amendment | [`governance/external-falsification-and-replication-r2-input-amendment-v1.2.md`](governance/external-falsification-and-replication-r2-input-amendment-v1.2.md) | Preregistered amendment (candidate until promoted to protected `main`) binding the corrected `EFR-R2` specification package after the root-of-trust audit repaired the reference verifiers. Preserves frozen EFR v1.0 and amendment [v1.1](governance/external-falsification-and-replication-r2-input-amendment-v1.1.md) byte-for-byte and amends the R2 input specification only. `EFR-R2` must not execute against the corrected specifications under v1.1 or the unamended v1.0 freeze. |
