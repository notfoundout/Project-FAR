...
- Canonical Vocabulary Index: `docs/glossary/canonical-vocabulary-index.md` is the canonical Prompt 3 glossary and vocabulary discovery index; it references canonical definitions without redefining protected mathematical content.
- Semantic Certification Report: `docs/audits/semantic-certification-report.md` is the canonical Prompt 3 semantic certification, terminology, glossary consistency, dependency matrix, reachability, and canonical-home report.
- Repository Architecture Certification Report: `docs/audits/repository-architecture-certification-report.md` is the canonical Prompt 4 repository architecture certification, report-root policy, reference-document policy, navigation, and discoverability report.
...
- Independent Repository Certification Audit: `docs/audits/independent-repository-certification-audit.md` is the canonical Prompt 7 independent certification matrix, governance consistency, integrity, regression, and automation verification audit.
