...
- Independent Repository Certification Audit: `docs/audits/independent-repository-certification-audit.md` is the canonical independent audit independent certification matrix, governance consistency, integrity, regression, and automation verification audit.
- Final Repository Certification Report: `docs/certification/final-repository-certification-report.md` is the canonical final repository certification decision, evidence matrix, repository integrity summary, and merge readiness assessment.
