...
| far-ir/2.0 Current Verification | [`specification/far-ir-2.0-current-verification.md`](specification/far-ir-2.0-current-verification.md) | Current authoritative `far-ir/2.0` verification rule (`contract_v2_strict`); the frozen `contract_v2.py` baseline is reserved for historical reproduction. |
