...
| Subagent execution | [`architecture/far-subagent-execution.md`](architecture/far-subagent-execution.md) | Provisional provider-neutral research routing, context isolation, and failure gates; no claim-promotion authority. |
