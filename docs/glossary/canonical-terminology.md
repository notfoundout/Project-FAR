...
| fourth/fifth operator | Historical global-basis search label. Operator count is not invariant without a fixed language, equivalence, and cost contract. | historical research | closed as an ill-posed global search | [`Project-FAR-Theory-Closure-v1.0.md`](../../theory/theorems/Project-FAR-Theory-Closure-v1.0.md) |
