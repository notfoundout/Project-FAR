...
| THM-INV-001 / FARA-W5-PROOF-001 | explicit representation-sensitive counterexample; executable corroboration, not proof-assistant verification | Two finite pairs agree under the frozen W5 contract, but nonmonotonic, causal, partial-order, and decoder-policy witnesses change conclusions across registered representations. Representation independence and universal invariance do not follow. |
