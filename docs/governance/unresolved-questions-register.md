...
- **UQ-T20:** What is the canonical definition and owner of `unresolved status`, and how is it distinguished from FARO `uncertainty` and the Charter artifact status `Unknown`? **Unresolved; the term carries normative force at `frameworks/FARA/admissibility-structure.md:111` with no located canonical definition. See `LIM-029`, `OP-16`.**
