...
- **UQ-T21:** Why do unresolved candidates carry no traceability or auditability obligation while classified candidates do, and is that asymmetry intended? **Unresolved; the asymmetry follows from the scoping of `admissibility-structure.md:117` and `:142` to "admissibility classification", and canonical text neither states nor defends it.**
