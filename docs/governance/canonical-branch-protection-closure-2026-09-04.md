...
The temporary `.github/workflows/bootstrap-canonical-protection.yml` workflow existed only to cross the initial unprotected-to-protected control-plane boundary. It is removed by the cleanup PR following this record. The permanent governed apply/read-back tooling remains in the repository.
