...
| LIM-020 | W5 tests six registered representation families over twelve project-authored fixtures; semantic equivalence for nonclassical systems and faithful finite recovery for oracle-dependent, continuous, and embodied systems remain insufficient. | Cross-representation invariance | Open; `FARA-W5-PROOF-001` refutes representation independence only within the frozen campaign and establishes no population or universal claim. |
