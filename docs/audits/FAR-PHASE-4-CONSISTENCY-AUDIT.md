...
FAR is eligible to be declared v1.0 Stable after the Phase 3 and Phase 4 audit changes are reviewed and merged.
...
This resolves the previous termination-condition gap.
...
The required artifacts exist or are supplied by the Phase 3 and Phase 4 audit branches.
...
FAR v1.0 may be frozen after the relevant PRs are reviewed and merged.
...
Merge the Phase 3 methodology audit branch first.

Then merge this Phase 4 consistency audit branch.

After both are merged, declare FAR v1.0 Stable in a dedicated milestone PR.
