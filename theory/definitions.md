...
A **representational structure** is an organized collection of representations together with the relationships between them.
...
FARA remains independent of any particular reasoning calculus.
...
A **resolution** is the candidate, or collection of candidates, selected from an admissibility structure according to the rules governing the investigation.# Definitions
...
# Definition 9 — Possibility Space

The **possibility space** of an investigation is the collection of all candidates admitted for consideration.

The possibility space represents the complete set of candidates available for evaluation.

---

# Definition 10 — Admissibility Structure (Ω)

The **admissibility structure**, denoted **Ω**, classifies the candidates within a possibility space according to the applicable reasoning calculus.
...
A **resolution** is the candidate, or collection of candidates, selected from an admissibility structure according to the rules governing the investigation.
