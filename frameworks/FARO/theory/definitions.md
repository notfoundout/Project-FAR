...
This document defines FARO-specific formal terminology.

Unless explicitly stated otherwise, every FARO-specific technical term refers to the definitions established in this document. Shared Project FAR terminology remains canonical in `../../../theory/definitions/definitions.md`.

Only canonical FARO-specific definitions belong in this document.
