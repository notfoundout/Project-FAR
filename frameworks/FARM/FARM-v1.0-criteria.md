# FARM v1.0 Stability Criteria

## Purpose

This document defines the criteria required before FARM may be declared v1.0 Stable.
...
FARM v1.0 Stable means FARM is suitable to serve as the canonical meta-framework coordination layer of Project FAR.

It does not mean all future integration requirements are known.
...
### 5. Defect Classification Present
...
- [x] consistency audit is complete.
